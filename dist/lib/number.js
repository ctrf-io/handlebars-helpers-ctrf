 ...
 */
export function toPercent(num, precision = 2) {
    return ((num || 0) * 100).toFixed(precision) + '%';
}
/**
 * Convert bytes to human readable format
 */
export function bytes(num, precision = 2) {
 ...
 * Format as currency
 */
export function currency(amount, currency = 'USD', locale = 'en') {
 ...
 */
export function abbreviate(num, precision = 1) {
    const n = num || 0;
