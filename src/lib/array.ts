 ...
 * ```
 */
export function before(array: any[], n: number): any[] | string {
  if (isUndefined(array)) return '';
 ...
 * ```
 */
export function eachIndex(array: any[], options: HandlebarsHelperOptions): string {
  let result = '';
...
export function filter(
  ...
  if (prop) {
    results = array.filter((val: any) => {
      return value === get(val, prop);
    });
  } else {
    // filter on a string value
    results = array.filter((v: any) => {
      return value === v;
    });
  }
 ...
 * ```
 */
export function first(array: any[], n?: number): any | any[] | string {
  if (isUndefined(array)) return '';
  if (!isNumber(n)) {
    return array[0];
  }
 ...
 * ```
 */
export function forEach(array: any[], options: HandlebarsHelperOptions): string {
  ...
  while (++i < len) {
    ...
    (item as any).total = len;
    (item as any).isFirst = i === 0;
    (item as any).isLast = i === (len - 1);
 ...
 * ```
 */
export function withAfter(array: any[], idx: number, options: HandlebarsHelperOptions): string {
  if (isUndefined(array)) return '';
 ...
 * ```
 */
export function withBefore(array: any[], idx: number, options: HandlebarsHelperOptions): string {
  if (isUndefined(array)) return '';
 ...
 * ```
 */
export function withFirst(array: any[], options: HandlebarsHelperOptions): string {
 ...
 * ```
 */
export function withLast(array: any[], n: number, options: HandlebarsHelperOptions): string {
  if (isUndefined(array)) return '';
 ...
 * ```
 */
export function last(array: any[], n?: number): any | any[] | string {
  if (isUndefined(array)) return '';
  if (!isNumber(n)) {
 ...
 * ```
 */
export function map(array: any[], options: HandlebarsHelperOptions): string {
  if (isUndefined(array)) return '';
  let result = '';
  for (let i = 0; i < array.length; i++) {
...
export function append(array: any[], value: any): any[] {
  if (isUndefined(array)) return [value];
  return [...array, value];
}
 ...
 * ```
 */
export function sort(array: any[], prop?: string): any[] {
  if (isUndefined(array)) return [];
 ...
 * ```
 */
export function inArray(array: any[], value: any): boolean {
  if (isUndefined(array)) return false;
...
export function isEqual(array1: any[], array2: any[]): boolean {
  if (isUndefined(array1) || isUndefined(array2)) return false;
 ...
 * ```
 */
export function avg(array: any[]): number {
  if (isUndefined(array) || array.length === 0) return 0;
